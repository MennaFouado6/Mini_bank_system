...
from transactions import deposit_interactive, withdraw_interactive, transfer_interactive, check_balance
...
def main():
    ...
    while True:
        ...
        if logged_in_account is None:
            ...
            print("5. List All Accounts (Admin)")
            print("6. Exit")
        ...
        # --- POST-LOGIN MENU ---
            ...
            if choice == "1":
                try:
                    deposit_interactive(logged_in_account)
                ...
                try:
                    withdraw_interactive(logged_in_account)
                    manager.save_accounts()
                except ValueError as e:
                    print(f"Error: {e}")
                ...
                if receiver_num == logged_in_account.account_number:
                    ...
                    if receiver is None:
                        ...
                        try:
                            transfer_interactive(logged_in_account, receiver)
                            manager.save_accounts()
                        except ValueError as e:
                            print(f"Error: {e}")
